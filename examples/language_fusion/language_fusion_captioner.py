...
from framefc7_stream_72kvoc_s2s_text_to_hdf5_data import *
...
def main():
  ...
  parser.add_argument("-n", "--netdeploy", type=str, help='deploy net',
                    default='deploy_lm_deepfus_img512_s2vt_glove.words_to_preds.prototxt')
  ...
  LSTM_NET_FILE = args.netdeploy
  RESULTS_DIR = './results/s2vt_glove'
